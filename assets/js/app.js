...
function syncSidebar() {
  ...
  /*  menu icono izquierdo  restaurante  */
  museums.eachLayer(function (layer) {
    if (map.hasLayer(museumLayer)) {
      if (map.getBounds().contains(layer.getLatLng())) {
        $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/restauran.png"></td><td class="feature-name">' + layer.feature.properties.NAME + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
      }
    }
  });
...
var theaters = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Nombre</th><td>" + feature.properties.NAME + "</td></tr>" + "<tr><th>Teléfono</th><td>" + feature.properties.TEL + "</td></tr>" + "<tr><th>Dirección</th><td>" + feature.properties.ADDRESS1 + "</td></tr>" + "<tr><th>Pagina Web</th><td><a class='url-break' href='" + feature.properties.URL + "' target='_blank'>" + feature.properties.URL + "</a></td></tr>" + "<table>";
      layer.on({
        click: function (e) {
...
/*  marca dle mapa restaurante Empty layer placeholder to add to layer control for listening when to add/remove museums to markerClusters layer */
var museumLayer = L.geoJson(null);
var museums = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.icon({
        iconUrl: "assets/img/restauran.png",
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
  ...
  /* tabla descripcion de restaurantes*/
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Nombre</th><td>" + feature.properties.NAME + "</td></tr>" + "<tr><th>Teléfono</th><td>" + feature.properties.TEL + "</td></tr>" + "<tr><th>Dirección</th><td>" + feature.properties.ADRESS1 + "</td></tr>" + "<tr><th>Pagina Web</th><td><a class='url-break' href='" + feature.properties.URL + "' target='_blank'>" + feature.properties.URL + "</a></td></tr>" + "<table>";
      layer.on({
        click: function (e) {
          $("#feature-title").html(feature.properties.NAME);
          $("#feature-info").html(content);
...
attributionControl.onAdd = function (map) {
  ...
  div.innerHTML = "<span class='hidden-xs'>Desarollado por<a href='https://www.facebook.com/juan.gaitan.capetillo?fref=ts'>Juan Gaitan</a> <a href='https://www.facebook.com/armandoo.ramiirez.3'>Armando Ramirez</a> | </span><a href='#' onclick='$(\"#attributionModal\").modal(\"show\"); return false;'>Attribution</a>";
  return div;
};
...
var baseLayers = {
  "Mapa de calles": mapquestOSM,
  "Imagenes Aereas": mapquestOAM,
  "Las imágenes con las calles": mapquestHYB
};
/*Menu de opcciones para mostrar puntos de interes y referencias*/
var groupedOverlays = {
  "Puntos de interes": {
    "<img src='assets/img/hotel.png' width='24' height='28'>&nbsp;Hoteles": theaterLayer,
    "<img src='assets/img/restauran.png' width='24' height='28'>&nbsp;Restaurantes": museumLayer
  },
  "Referencia": {
    "Condados": boroughs,
    "Lineas de metro": subwayLines
  }
};
...
$(document).one("ajaxStop", function () {
  ...
  $("#searchbox").typeahead({
    ...
    /* iconos menu izquierdo hotel*/
  }, {
    name: "Theaters",
    displayKey: "name",
    source: theatersBH.ttAdapter(),
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/img/hotel.png' width='24' height='28'>&nbsp;Theaters</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}}</small>"].join(""))
    }
  }, 
/*iconos de menu izquierdo restaurante*/
  {
    name: "Museums",
    displayKey: "name",
    source: museumsBH.ttAdapter(),
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/img/restauran.png' width='24' height='28'>&nbsp;Museums</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}}</small>"].join(""))
    }
  }, {
    name: "GeoNames",
